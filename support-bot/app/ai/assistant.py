...
OPERATOR_TOOLS = [
    {
        ...
        "description": (
            ...
            "3. Переданный контекст не содержит прямого ответа на вопрос пользователя.\n"
            "4. Переданные фрагменты противоречат друг другу или относятся к разным темам.\n"
            "Не вызывай функцию, если передан хотя бы один прямой фрагмент контекста, по которому можно кратко ответить."
        ),
